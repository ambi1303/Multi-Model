...
import { AppFooter } from './components/SurveySharedUI';
import Sidebar from './components/Sidebar';
import { SentimentProvider } from './SentimentContext';
...
function App() {
  ...
  const menuItems = [
    ...
    { text: 'Video Analysis', icon: <span className="pi pi-video" />, path: '/video' },
  ];
